...
Split into leaf modules so the renderers in :mod:`nwn_wiki.render` can import
...
* :mod:`nwn_wiki.htmlgen.blocks` -- the repeated page-body wrappers (TOC
  sidebar, two-column items layout, meta definition list).
